            ...
            if (fullConfig.containerShowLogo) { 
                ...
                if( userConfig.containerLogoStyle ){
                    ...
                    if(fullConfig.containerLogoStyle.toString() === "-1"){
                        if(fullConfig.stuffType==="linkunit1"){
                            logoStyle = "bd-logo2";
                        }
                    }
                }

                var logoOption = { "className": logoStyle, "isGongyi" : fullConfig.isGongyi };
    ...
    return {
        ...
        text: function (option) {
            ...
            for(var i=0, count=container.childNodes.length; i<count; i++){
                ...
                if( itemHeight > itemContentHeight ){
        ...
        */
        layoutIcon: function(width, height, option) {
            var image = {
                ...
                dataType: "image",
                domName: "div",
                cssName: this.GetCssName("titlefronticon", option),
                dataKey: "icon"
            };
            ...
            style["padding-top"] = Math.floor((option.templateHeight/option.adRowCount-width-option.itemPaddingTop)/2) || 0;
